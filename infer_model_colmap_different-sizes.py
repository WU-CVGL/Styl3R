...
def infer(cfg_dict: DictConfig):
    ...
    data_dir = Path('colmap_test_data/re10k_720p/to_a100/0a0d_3')
    data_dir = Path('colmap_test_data/ego_centric_360/ego_centric')
    ...
    ctx_indices = torch.tensor([50, 80])
    num_ctx_views = 12
    # ----------------------------------------------------------------------------------------------
    ...
    # data_cfg.input_image_shape = [720, 1280]
