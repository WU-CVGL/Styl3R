...
def infer(cfg_dict: DictConfig):
    ...
    # cfg.checkpointing.load = '/ssdwork/liuxiang/noposplat_private/outputs/exp_re10k_multi-view_tok-sty-stylization/2025-04-30_12-43-53/checkpoints/epoch_0-step_18750.ckpt'
    
    # re10k, h3 + h4 for content loss
    # cfg.checkpointing.load = '/ssdwork/liuxiang/noposplat_private/outputs/exp_re10k_multi-view_tok-sty-stylization_content-h3-h4/2025-05-01_23-06-44/checkpoints/epoch_0-step_35000.ckpt'
    
    # re10k without identity loss
    # cfg.checkpointing.load = '/ssdwork/liuxiang/noposplat_private/ckpts/epoch_0-step_35000_no-identity.ckpt'
    
    # -------- 4view -----------
    # re10k
    # cfg.checkpointing.load = '/ssdwork/liuxiang/noposplat_private/outputs/exp_re10k_4multi-view_tok-sty-stylization/2025-05-04_02-35-28/checkpoints/epoch_0-step_35000.ckpt'
    
    # re10k + dl3dv
    cfg.checkpointing.load = '/ssdwork/liuxiang/noposplat_private/outputs/exp_re10k_dl3dv_4multi-view_tok-sty-stylization_b2x3/2025-05-06_19-31-34/checkpoints/epoch_0-step_35000.ckpt'
    ...
    scene_keys = [
     'scan82_train', 'scan103_train', 'scan34_train',
     'scan38_train', 'scan40_train', 'scan41_train',
     'scan110_train', 'scan114_train', 'scan1_train',
     'scan8_train', 'scan21_train', 'scan30_train',
     'scan31_train']
    
    scene_idx = scene_keys[0]
    ...
    #     '/ssdwork/datasets/wikiart_combine/images_combine/train/' \
    ...
    ctx_indices = torch.tensor([22, 25])
    num_ctx_views = 2
    # ----------------------------------------------------------------------------------------------
