...
from .backbone_croco_enc import AsymmetricCroCoEnc, BackboneCrocoEncCfg

BACKBONES: dict[str, Backbone[Any]] = {
    "resnet": BackboneResnet,
    "dino": BackboneDino,
    "croco": AsymmetricCroCo,
    "croco_enc": AsymmetricCroCoEnc,
    "croco_multi": AsymmetricCroCoMulti,
}

BackboneCfg = BackboneResnetCfg | BackboneDinoCfg | BackboneCrocoCfg | BackboneCrocoEncCfg
