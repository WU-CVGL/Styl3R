...
from .dpt_gs_sh_head import create_gs_sh_dpt_head
...
def head_factory(head_type, output_mode, net, has_conf=False, out_nchan=3):
    ...
    elif head_type == 'dpt_gs_sh' and output_mode == 'gs_params':
        return create_gs_sh_dpt_head(net, has_conf=False, out_nchan=out_nchan, postprocess_func=None)
    else:
